...
_.extend(Controller.prototype, Backbone.Model.prototype, {
  ...
  _setTemplate: function(){
    ...
    console.log('setTemplate?', this.template)
  ...
  _startListening: function(){
    ...
    console.log('CONTROLLER OUTPUT', this)
...
Controller.extend = function(protoProps, staticProps) {
    var parent = this,
        ...
        configProperties = {'routes':1, 'template':1, 'defaults':1, 'outlet':1, 'url':1, 'urlRoot':1, 'idAttribute':1, 'id':1};
    ...
    _.each(protoProps, function(value, key, protoProps){
      ...
      console.log("EXTENDING", this.prototype)
      // TODO: better error output.
